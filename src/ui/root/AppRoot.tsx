...
import { LocalStorageWrapper, MapDisplayMode, MapDisplayModes, MapDisplayModeStorage, SplitSettingStorage, SplitTypeSetting, Theme, Themes, ThemeStorage } from "data/settings";
